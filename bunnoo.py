...
db = client['bunno']
FORWARD_CHANNEL_ID = -1001340422520
CHANNEL_ID = -1001340422520
error_channel_id = -1001340422520

# Fetching admin IDs from the database
def get_admin_user_ids():
    admins = db.admins.find({}, {"telegram_id": 1})
    return {admin["telegram_id"] for admin in admins}
try:
    print("Connected to MongoDB")
    print(db.list_collection_names())  # This will list the collections in the 'bunno' database
...
db.admins.insert_one({"telegram_id": '1055000829'})
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/bunno_selling/18918 *", parse_mode='Markdown')
